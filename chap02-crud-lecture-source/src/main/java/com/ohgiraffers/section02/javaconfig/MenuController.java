...
public class MenuController {
    ...
    public void findAllMenus() {
        ...
        List<com.ohgiraffers.section02.javaconfig.MenuDTO> menuList = menuService.findAllMenus();
        if (!menuList.isEmpty()) {
            printResult.printMenus(menuList);
        }else {
            printResult.printErrorMessage("조회할 메뉴가 없다.");
        }
    }
    ...
    public void findMenuByMenuCode(Map<String, String> parameter) {
        ...
        com.ohgiraffers.section02.javaconfig.MenuDTO menu = menuService.findMenuByMenuCode(menuCode);

        if(menu != null) {
            printResult.printMenu(menu);
        } else {
            printResult.printErrorMessage(menuCode + "번의 메뉴는 없다.");
        }
    }
    ...
    public void registMenu(Map<String, String> parameter) {
        ...
        com.ohgiraffers.section02.javaconfig.MenuDTO menu = new com.ohgiraffers.section02.javaconfig.MenuDTO();
    ...
    public void modifyMenu(Map<String, String> parameter) {
        ...
        com.ohgiraffers.section02.javaconfig.MenuDTO menu = new MenuDTO();
